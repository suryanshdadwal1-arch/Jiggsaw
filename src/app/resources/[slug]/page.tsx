    ...
    <main className="min-h-screen bg-white text-black">
      ...
      <article>
        <header className="border-b border-black/10 px-4 py-12 sm:px-6 sm:py-16 lg:px-10">
          <div className="mx-auto max-w-[1280px]">
            <Link href="/resources" className="font-display text-xs font-black uppercase tracking-[0.2em] text-brand-orange hover:text-black">Resources</Link>
      ...
      <section className="bg-black px-4 py-12 text-white sm:px-6 sm:py-14 lg:px-10">
        <div className="mx-auto flex max-w-[1280px] flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          ...
          <Link href="/contact" className="shrink-0 border border-white px-5 py-3 font-display text-xs font-black uppercase tracking-[0.18em] transition hover:bg-white hover:text-black">Start a conversation</Link>
        </div>
      </section>
      <SiteFooter />
    </main>
