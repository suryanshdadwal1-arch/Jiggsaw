...
import { getResourceArticle, resourceArticles } from "@/lib/articles";
...
export async function generateMetadata({ params }: ResourceArticlePageProps): Promise<Metadata> {
  ...
  return article ? { title: `${article.title} | Jiggsaw Resources`, description: article.description } : {};
}
    ...
    <main className="min-h-screen bg-white text-black">
      ...
      <article>
        <header className="border-b border-black/10 px-4 py-12 sm:px-6 sm:py-16 lg:px-10">
          <div className="mx-auto max-w-[1280px]">
            <Link href="/resources" className="inline-flex min-h-11 items-center font-display text-xs font-black uppercase tracking-[0.2em] text-brand-orange hover:text-black">Resources</Link>
        ...
        <div className="px-4 py-8 sm:px-6 sm:py-10 lg:px-10">
          <div data-reveal className="relative mx-auto aspect-[16/8] max-w-[1280px] overflow-hidden bg-black">
        ...
        <div className="px-4 pb-16 sm:px-6 sm:pb-20 lg:px-10">
          <div className="mx-auto grid max-w-[1120px] gap-12 lg:grid-cols-[0.28fr_0.72fr]">
            <aside data-reveal className="border-t border-black/10 pt-5">
              <p className="font-display text-xs font-black uppercase tracking-[0.2em] text-brand-orange">In this note</p>
            ...
            <div className="space-y-12">
              ...
              <section data-reveal className="border-t border-black pt-7">
                <p className="font-display text-xs font-black uppercase tracking-[0.2em] text-brand-orange">Keep in mind</p>
      ...
      <section className="bg-black px-4 py-12 text-white sm:px-6 sm:py-14 lg:px-10">
        <div className="mx-auto flex max-w-[1280px] flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          <h2 className="max-w-2xl font-display text-3xl font-black uppercase leading-[0.96] tracking-[-0.025em] sm:text-4xl">Ready to connect the next piece?</h2>
          <Link href="/contact" className="inline-flex min-h-11 shrink-0 items-center justify-center border border-white px-5 font-display text-xs font-black uppercase tracking-[0.18em] transition hover:bg-white hover:text-black">Start a conversation</Link>
        </div>
      </section>
      <SiteFooter />
    </main>
